...
export declare class OrderPaymentCardComponent {
    ...
    } & Pick<import("@vendure/admin-ui/core").Payment, "method" | "transactionId" | "metadata" | "id" | "createdAt" | "state" | "nextStates" | "amount" | "errorMessage"> & {
        refunds: ({
            __typename?: "Refund" | undefined;
        } & Pick<import("@vendure/admin-ui/core").Refund, "method" | "transactionId" | "metadata" | "items" | "id" | "createdAt" | "state" | "total" | "adjustment" | "paymentId" | "reason"> & {
            orderItems: ({
                __typename?: "OrderItem" | undefined;
            } & Pick<import("@vendure/admin-ui/core").OrderItem, "id">)[];
        })[];
    }>;
