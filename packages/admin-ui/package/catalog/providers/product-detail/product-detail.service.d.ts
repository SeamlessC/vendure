import { CreateProductInput, DataService, FacetWithValues, GetProductWithVariants, LanguageCode, UpdateProductInput, UpdateProductMutation, UpdateProductOptionInput, UpdateProductVariantInput, UpdateProductVariantsMutation } from '@vendure/admin-ui/core';
...
export declare class ProductDetailService {
    ...
    getTaxCategories(): Observable<({
        ...
        __typename?: "TaxCategory" | undefined;
    } & Pick<import("@vendure/admin-ui/core").TaxCategory, "id" | "createdAt" | "updatedAt" | "name" | "isDefault">)[]>;
    createProductWithVariants(input: CreateProductInput, createVariantsConfig: CreateProductVariantsConfig, languageCode: LanguageCode): Observable<{
        createProductVariants: import("@vendure/admin-ui/core").Maybe<{
            ...
            taxCategory: {
                __typename?: "TaxCategory" | undefined;
            } & Pick<import("@vendure/admin-ui/core").TaxCategory, "id" | "name">;
            options: ({
                __typename?: "ProductOption" | undefined;
            } & {
                __typename?: "ProductOption" | undefined;
            } & Pick<import("@vendure/admin-ui/core").ProductOption, "id" | "createdAt" | "updatedAt" | "name" | "code" | "languageCode" | "groupId"> & {
                translations: ({
                    __typename?: "ProductOptionTranslation" | undefined;
                } & Pick<import("@vendure/admin-ui/core").ProductOptionTranslation, "id" | "name" | "languageCode">)[];
            })[];
            facetValues: ({
            ...
            featuredAsset?: import("@vendure/admin-ui/core").Maybe<{
            ...
            } & Pick<import("@vendure/admin-ui/core").ProductVariantTranslation, "id" | "name" | "languageCode">)[];
            channels: ({
                __typename?: "Channel" | undefined;
            } & Pick<import("@vendure/admin-ui/core").Channel, "id" | "code">)[];
        }>[];
        productId: string;
    }>;
    createProductOptionGroups(groups: Array<{
        ...
        __typename?: "ProductOptionGroup" | undefined;
    } & Pick<import("@vendure/admin-ui/core").ProductOptionGroup, "id" | "createdAt" | "updatedAt" | "name" | "code" | "languageCode"> & {
        translations: ({
            __typename?: "ProductOptionGroupTranslation" | undefined;
        } & Pick<import("@vendure/admin-ui/core").ProductOptionGroupTranslation, "id" | "name">)[];
        options: ({
            __typename?: "ProductOption" | undefined;
        } & Pick<import("@vendure/admin-ui/core").ProductOption, "id" | "name" | "code" | "languageCode"> & {
            translations: ({
                __typename?: "ProductOptionTranslation" | undefined;
            } & Pick<import("@vendure/admin-ui/core").ProductOptionTranslation, "name">)[];
        })[];
    })[]>;
    ...
    updateProductOption(input: UpdateProductOptionInput & {
        autoUpdate: boolean;
    }, product: GetProductWithVariants.Product, languageCode: LanguageCode): Observable<any>;
    deleteProductVariant(id: string, productId: string): Observable<import("@vendure/admin-ui/core").GetProductWithVariantsQuery>;
}
