    ...
    ***************************************************************************** */
    ...
    var PromotionDetailComponent = /** @class */ (function (_super) {
        ...
        function PromotionDetailComponent(router, route, serverConfigService, changeDetector, dataService, formBuilder, notificationService) {
            ...
            _this.allConditions = [];
            _this.allActions = [];
            _this.customFields = _this.getCustomFieldConfig('Promotion');
    ...
    var PromotionListComponent = /** @class */ (function (_super) {
        ...
        function PromotionListComponent(dataService, router, route, notificationService, modalService) {
            ...
            _this.searchForm = new forms.FormGroup({
                name: new forms.FormControl(''),
                couponCode: new forms.FormControl(''),
            });
            _super.prototype.setQueryFn.call(_this, function () {
                ...
                return (_a = _this.dataService.promotion).getPromotions.apply(_a, __spreadArray([], __read(args))).refetchOnChannelChange();
            }, function (data) { return data.promotions; }, function (skip, take) { return _this.createQueryOptions(skip, take, _this.searchForm.value); });
            return _this;
        }
        PromotionListComponent.prototype.ngOnInit = function () {
            var _this = this;
            _super.prototype.ngOnInit.call(this);
            rxjs.merge(this.searchForm.valueChanges.pipe(operators.debounceTime(250)), this.route.queryParamMap)
        ...
        PromotionListComponent.prototype.createQueryOptions = function (skip, take, searchForm) {
            var filter = {};
    ...
    PromotionResolver.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PromotionResolver_Factory() { return new PromotionResolver(i0__namespace.ɵɵinject(i1__namespace.Router), i0__namespace.ɵɵinject(i2__namespace.DataService)); }, token: PromotionResolver, providedIn: "root" });
