...
type ErrorResult_ShopClosedError_Fragment = (
  { __typename?: 'ShopClosedError' }
...
export namespace Order {
  ...
  export type Payments = NonNullable<(NonNullable<OrderFragment['payments']>)[number]>;
  ...
  export type CustomFields = (NonNullable<OrderFragment['customFields']>);
}
