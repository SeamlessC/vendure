 ...
 */
function parseChannelParam(connection, entity, channelId, entityAlias) {
    const metadata = connection.getMetadata(entity);
    const alias = entityAlias !== null && entityAlias !== void 0 ? entityAlias : metadata.name.toLowerCase();
