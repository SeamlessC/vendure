...
let TranslatorService = class TranslatorService {
    ...
    translate(translatable, ctx, translatableRelations = []) {
        return translate_entity_1.translateDeep(translatable, [ctx.languageCode, ctx.channel.defaultLanguageCode, this.configService.defaultLanguageCode], translatableRelations);
    }
};
