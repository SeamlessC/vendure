        ...
        for (const action of this.actions) {
            ...
            if (promotionAction instanceof promotion_action_1.PromotionItemAction) {
                if (this.isOrderItemArg(args)) {
                    ...
                    amount += Math.round(await promotionAction.execute(ctx, orderItem, orderLine, action.args, state, this));
                }
            }
                ...
                if (this.isShippingArg(args)) {
                    ...
                    amount += Math.round(await promotionAction.execute(ctx, shippingLine, order, action.args, state, this));
                }
            }
        }
        if (amount !== 0) {
