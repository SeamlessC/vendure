...
__decorate([
    typeorm_1.OneToMany(type => authentication_method_entity_1.AuthenticationMethod, method => method.user),
...
__decorate([
    typeorm_1.Column(type => custom_entity_fields_1.CustomUserFields),
