...
let CustomerGroupService = class CustomerGroupService {
    ...
    findOne(ctx, customerGroupId, relations = []) {
        return this.connection.getRepository(ctx, customer_group_entity_1.CustomerGroup).findOne(customerGroupId, { relations });
    }
    /**
     * @description
    ...
    async create(ctx, input) {
        ...
        return utils_1.assertFound(this.findOne(ctx, savedCustomerGroup.id));
    }
