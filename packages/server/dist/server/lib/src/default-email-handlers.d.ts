...
export declare const orderConfirmationHandler: EmailEventHandler<
    'order-confirmation',
    import('./types').EventWithAsyncData<
        OrderStateTransitionEvent,
        {
    ...
    >
>;
export declare const emailVerificationHandler: EmailEventHandler<
    'email-verification',
    AccountRegistrationEvent
>;
export declare const passwordResetHandler: EmailEventHandler<'password-reset', PasswordResetEvent>;
export declare const emailAddressChangeHandler: EmailEventHandler<
 ...
 */
export declare function transformOrderLineAssetUrls(
    ctx: RequestContext,
    order: Order,
    injector: Injector,
): Order;
 ...
 */
export declare function hydrateShippingLines(
    ctx: RequestContext,
    order: Order,
    injector: Injector,
