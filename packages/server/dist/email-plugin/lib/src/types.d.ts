 ...
 */
export declare type EmailTransportOptions =
...
export declare type SerializedAttachment = OptionalToNullable<
    Omit<EmailAttachment, 'content'> & {
        content: string | null;
    }
>;
 ...
 * @docsPage Email Plugin Types
 */
export declare type SetTemplateVarsFn<Event> = (
    event: Event,
    globals: {
        [key: string]: any;
    },
 ...
 * @docsPage Email Plugin Types
 */
export declare type SetAttachmentsFn<Event> = (
    event: Event,
 ...
 * @docsPage Email Plugin Types
 */
export declare type SetOptionalAddressFieldsFn<Event> = (
    event: Event,
