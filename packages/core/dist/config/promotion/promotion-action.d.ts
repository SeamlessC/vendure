 ...
 */
export declare type ExecutePromotionItemActionFn<T extends ConfigArgs, U extends Array<PromotionCondition<any>>> = (ctx: RequestContext, orderItem: OrderItem, orderLine: OrderLine, args: ConfigArgValues<T>, state: ConditionState<U>, promotion: Promotion) => number | Promise<number>;
/**
 * @description
 ...
 * @docsPage promotion-action
 */
export declare type ExecutePromotionOrderActionFn<T extends ConfigArgs, U extends Array<PromotionCondition<any>>> = (ctx: RequestContext, order: Order, args: ConfigArgValues<T>, state: ConditionState<U>, promotion: Promotion) => number | Promise<number>;
/**
 * @description
 * The function which is used by a PromotionOrderAction to calculate the
 * discount on the Order.
 ...
 * @docsPage promotion-action
 */
export declare type ExecutePromotionShippingActionFn<T extends ConfigArgs, U extends Array<PromotionCondition<any>>> = (ctx: RequestContext, shippingLine: ShippingLine, order: Order, args: ConfigArgValues<T>, state: ConditionState<U>, promotion: Promotion) => number | Promise<number>;
/**
 * @description
 ...
 * @experimental
 */
declare type PromotionActionSideEffectFn<T extends ConfigArgs> = (ctx: RequestContext, order: Order, args: ConfigArgValues<T>, promotion: Promotion) => void | Promise<void>;
/**
 * @description
...
export declare class PromotionItemAction<T extends ConfigArgs = ConfigArgs, U extends Array<PromotionCondition<any>> = []> extends PromotionAction<T, U> {
    ...
    /** @internal */
    execute(ctx: RequestContext, orderItem: OrderItem, orderLine: OrderLine, args: ConfigArg[], state: PromotionState, promotion: Promotion): number | Promise<number>;
}
/**
 * @description
