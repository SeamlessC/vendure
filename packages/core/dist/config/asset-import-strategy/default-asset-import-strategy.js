...
function fetchUrl(urlString) {
    return new Promise((resolve, reject) => {
        ...
        get(url, {
            ...
            if (statusCode !== 200) {
                vendure_logger_1.Logger.error(`Failed to fetch "${urlString.substr(0, 100)}", statusCode: ${statusCode}`);
...
class DefaultAssetImportStrategy {
    ...
    getStreamFromUrl(assetUrl) {
        ...
        return rxjs_1.from(fetchUrl(assetUrl))
            .pipe(operators_1.retryWhen(errors => errors.pipe(operators_1.tap(value => {
        ...
        }), operators_1.delay(retryDelayMs !== null && retryDelayMs !== void 0 ? retryDelayMs : 200), operators_1.take(retryCount !== null && retryCount !== void 0 ? retryCount : 3))))
            .toPromise();
    }
