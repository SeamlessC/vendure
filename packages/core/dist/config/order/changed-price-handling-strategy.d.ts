...
export interface ChangedPriceHandlingStrategy extends InjectableStrategy {
     ...
     */
    handlePriceChange(ctx: RequestContext, current: PriceCalculationResult, existingItems: OrderItem[], order: Order): PriceCalculationResult | Promise<PriceCalculationResult>;
}
