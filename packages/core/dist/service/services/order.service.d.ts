...
export declare class OrderService {
    ...
    private translator;
    constructor(globalSettingsService: GlobalSettingsService, connection: TransactionalConnection, configService: ConfigService, productVariantService: ProductVariantService, customerService: CustomerService, countryService: CountryService, orderCalculator: OrderCalculator, shippingCalculator: ShippingCalculator, orderStateMachine: OrderStateMachine, orderMerger: OrderMerger, paymentService: PaymentService, paymentStateMachine: PaymentStateMachine, paymentMethodService: PaymentMethodService, fulfillmentService: FulfillmentService, listQueryBuilder: ListQueryBuilder, stockMovementService: StockMovementService, refundStateMachine: RefundStateMachine, historyService: HistoryService, promotionService: PromotionService, eventBus: EventBus, zoneService: ZoneService, channelService: ChannelService, orderModifier: OrderModifier, customFieldRelationService: CustomFieldRelationService, requestCache: RequestContextCacheService, translator: TranslatorService);
    /**
     * @description
    ...
    transitionOrderIfTotalIsCovered(ctx: RequestContext, order: Order): Promise<Order | OrderStateTransitionError>;
    /**
     * @description
    ...
    getOrderOrThrow(ctx: RequestContext, orderId: ID): Promise<Order>;
    ...
    private groupOrderItemsIntoLines;
}
