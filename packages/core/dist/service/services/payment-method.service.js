...
let PaymentMethodService = class PaymentMethodService {
    constructor(connection, configService, listQueryBuilder, eventBus, configArgService, channelService, customFieldRelationService) {
    ...
    async update(ctx, input) {
        ...
        this.eventBus.publish(new payment_method_event_1.PaymentMethodEvent(ctx, updatedPaymentMethod, 'updated', input));
