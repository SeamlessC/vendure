...
let ProductOptionService = class ProductOptionService {
    ...
    async delete(ctx, id) {
            ...
            try {
                ...
                for (const translation of productOption.translations) {
                    await this.connection
                        .getRepository(ctx, product_option_translation_entity_1.ProductOptionTranslation)
                        .remove(translation);
                }
        ...
        this.eventBus.publish(new product_option_event_1.ProductOptionEvent(ctx, productOption, 'deleted', id));
        return {
