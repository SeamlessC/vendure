...
let CustomerService = class CustomerService {
    ...
    findAll(ctx, options, relations = []) {
        ...
        const hasPostalCodeFilter = !!((_b = (_a = options) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.postalCode);
     ...
     * to the current active Channel only.
     */
    findOneByPhoneNumber(ctx, phoneNumber, filterOnChannel = true) {
        let query = this.connection
            .getRepository(ctx, customer_entity_1.Customer)
            .createQueryBuilder('customer')
            .leftJoin('customer.channels', 'channel')
