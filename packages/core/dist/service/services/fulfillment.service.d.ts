...
export declare class FulfillmentService {
    ...
    getFulfillmentLineSummary(ctx: RequestContext, id: ID): Promise<Array<{
        orderLine: OrderLine;
        quantity: number;
    }>>;
    getFulfillmentsByOrderLineId(ctx: RequestContext, orderLineId: ID): Promise<Array<{
     ...
     */
    getFulfillmentByOrderItemId(ctx: RequestContext, orderItemId: ID): Promise<Fulfillment | undefined>;
    /**
     * @description
