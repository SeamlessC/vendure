 ...
 */
export declare function parseChannelParam<T extends VendureEntity>(connection: Connection, entity: Type<T>, channelId: ID, entityAlias?: string): WhereCondition | undefined;
