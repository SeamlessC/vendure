...
export declare class DraftOrderResolver {
    ...
    setCustomerForDraftOrder(ctx: RequestContext, args: MutationSetCustomerForDraftOrderArgs): Promise<ErrorResultUnion<SetCustomerForDraftOrderResult, Order>>;
