...
let DraftOrderResolver = class DraftOrderResolver {
    ...
    async setCustomerForDraftOrder(ctx, args) {
        ...
        if (args.customerId) {
            ...
            if (index_1.isGraphQlErrorResult(result)) {
                return result;
            }
            customer = result;
        }
...
__decorate([
    ...
    graphql_1.Mutation(),
    allow_decorator_1.Allow(generated_types_1.Permission.CreateOrder),
...
__decorate([
    transaction_decorator_1.Transaction(),
    graphql_1.Mutation(),
    allow_decorator_1.Allow(generated_types_1.Permission.DeleteOrder),
    __param(0, request_context_decorator_1.Ctx()),
...
__decorate([
    transaction_decorator_1.Transaction(),
    graphql_1.Mutation(),
    allow_decorator_1.Allow(generated_types_1.Permission.UpdateOrder, generated_types_1.Permission.Owner),
    __param(0, request_context_decorator_1.Ctx()),
    __param(1, graphql_1.Args()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [request_context_1.RequestContext, Object]),
