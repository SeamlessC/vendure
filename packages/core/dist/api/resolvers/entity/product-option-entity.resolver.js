...
let ProductOptionEntityResolver = class ProductOptionEntityResolver {
    ...
    async group(ctx, option) {
        ...
        return this.requestContextCache.get(ctx, `ProductOptionEntityResolver.group(${option.groupId})`, () => utils_1.assertFound(this.productOptionGroupService.findOne(ctx, option.groupId)));
    }
};
__decorate([
...
ProductOptionEntityResolver = __decorate([
    graphql_1.Resolver('ProductOption'),
