...
import { InvalidCredentialsError, NativeAuthStrategyError as ShopNativeAuthStrategyError, NotVerifiedError } from '../../../common/error/generated-graphql-shop-errors';
...
export declare class BaseAuthResolver {
    ...
    protected requireNativeAuthStrategy(): AdminNativeAuthStrategyError | ShopNativeAuthStrategyError | undefined;
}
