...
const order_item_entity_resolver_1 = require("./resolvers/entity/order-item-entity.resolver");
...
exports.entityResolvers = [
    ...
    order_item_entity_resolver_1.OrderItemEntityResolver,
...
AdminApiModule = __decorate([
    common_1.Module({
        imports: [
            ...
            ...dynamic_plugin_api_module_1.createDynamicGraphQlModulesForPlugins('admin'),
        ],
...
ShopApiModule = __decorate([
    common_1.Module({
        imports: [ApiSharedModule, ...dynamic_plugin_api_module_1.createDynamicGraphQlModulesForPlugins('shop')],
