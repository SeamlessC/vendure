...
let OrderLine = class OrderLine extends base_entity_1.VendureEntity {
    ...
    firstActiveItemPropOr(prop, defaultVal) {
        var _a;
        const items = this.activeItems.length ? this.activeItems : (_a = this.items) !== null && _a !== void 0 ? _a : [];
...
__decorate([
    typeorm_1.OneToMany(type => order_item_entity_1.OrderItem, item => item.line, { eager: true }),
...
__decorate([
    calculated_decorator_1.Calculated({ relations: ['items'] }),
