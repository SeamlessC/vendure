...
let FastImporterService = class FastImporterService {
    ...
    async createProduct(input) {
        ...
        if (input.assetIds) {
            ...
            await this.connection.getRepository(this.importCtx, product_asset_entity_1.ProductAsset).save(productAssets, { reload: false });
        }
        return product.id;
    }
    ...
    async createProductVariant(input) {
        ...
        if (input.assetIds) {
            ...
            await this.connection.getRepository(this.importCtx, product_variant_asset_entity_1.ProductVariantAsset).save(variantAssets, { reload: false });
        }
        ...
        for (const channelId of assignedChannelIds) {
            ...
            await this.connection.getRepository(this.importCtx, product_variant_price_entity_1.ProductVariantPrice).save(variantPrice, { reload: false });
        }
