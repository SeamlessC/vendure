...
export class ShopClosedError extends ErrorResult {
  readonly __typename = 'ShopClosedError';
  readonly errorCode = 'SHOP_CLOSED_ERROR' as any;
...
export const shopErrorOperationTypeResolvers = {
  ...
  DeleteCustomerAccountResult: {
    __resolveType(value: any) {
      return isGraphQLError(value) ? (value as any).__typename : 'DeletionResponse';
    },
  },
