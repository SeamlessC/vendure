...
let ShippingMethod = class ShippingMethod extends base_entity_1.VendureEntity {
    constructor(input) {
        ...
        this.allCheckers = {};
        this.allCalculators = {};
        const checkers = config_helpers_1.getConfig().shippingOptions.shippingEligibilityCheckers || [];
        const calculators = config_helpers_1.getConfig().shippingOptions.shippingCalculators || [];
...
__decorate([
    typeorm_1.OneToMany(type => shipping_method_translation_entity_1.ShippingMethodTranslation, translation => translation.base, { eager: true }),
    __metadata("design:type", Array)
], ShippingMethod.prototype, "translations", void 0);
__decorate([
    typeorm_1.Column(type => custom_entity_fields_1.CustomShippingMethodFields),
