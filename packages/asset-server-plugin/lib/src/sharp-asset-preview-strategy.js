    ...
    async generatePreviewImage(ctx, mimeType, data) {
        ...
        if (assetType === generated_types_1.AssetType.IMAGE) {
            try {
                ...
                core_1.Logger.error(`An error occurred when generating preview for image with mimeType ${mimeType}: ${(_a = err.message) !== null && _a !== void 0 ? _a : err.toString()}`, constants_1.loggerCtx);
