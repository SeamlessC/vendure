...
export declare type Extension = AdminUiExtension | TranslationExtension | StaticAssetExtension | GlobalStylesExtension | SassVariableOverridesExtension;
/**
 * @description
 ...
 * @docsCategory UiDevkit
 */
export declare type UiExtensionCompilerProcessArgument = string | [string, any];
/**
 * @description
